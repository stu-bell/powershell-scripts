...
2. Right click the shortcut you just created > Properties > Target

![Screenshot of shorcut properties](./imgs/ShortcutProperties.png)

The target is the file path to your script. Paste the following text BEFORE the path to your script file:
...
Note the space between -File and the start of your file path.
